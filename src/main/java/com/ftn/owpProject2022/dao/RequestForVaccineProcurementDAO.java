...
public interface RequestForVaccineProcurementDAO {
    ...
    int save(RequestForVaccineProcurement requestForVaccineProcurement);
    int update(RequestForVaccineProcurement requestForVaccineProcurement);
